...
export interface PersonalityData {
  traits: string[]; // 10項特質關鍵字
  description: string; // 200-400字說明
}
...
// 相容性星級表（1-5星），每組配對只定義一次，雙向查詢
const compatibilityMatrix: Record<string, number> = {
  'aries-leo': 5, 'aries-sagittarius': 5, 'aries-gemini': 4,
  'aries-scorpio': 3, 'aries-aquarius': 3, 'aries-taurus': 2,
  'aries-virgo': 2, 'aries-libra': 2, 'aries-cancer': 2,
  'aries-capricorn': 2, 'aries-pisces': 2,
  'taurus-virgo': 5, 'taurus-capricorn': 5, 'taurus-cancer': 4,
  'taurus-pisces': 4, 'taurus-scorpio': 3, 'taurus-gemini': 2,
  'taurus-libra': 2, 'taurus-aquarius': 2, 'taurus-aries': 2,
  'taurus-leo': 2, 'taurus-sagittarius': 2,
  'gemini-libra': 5, 'gemini-aquarius': 5, 'gemini-sagittarius': 4,
  'gemini-aries': 4, 'gemini-leo': 3, 'gemini-virgo': 2,
  'gemini-cancer': 2, 'gemini-taurus': 2, 'gemini-capricorn': 2,
  'gemini-scorpio': 2, 'gemini-pisces': 2,
  'cancer-scorpio': 5, 'cancer-pisces': 5, 'cancer-taurus': 4,
  'cancer-virgo': 4, 'cancer-capricorn': 3, 'cancer-gemini': 2,
  'cancer-libra': 2, 'cancer-aries': 2, 'cancer-leo': 2,
  'cancer-sagittarius': 2, 'cancer-aquarius': 2,
  'leo-sagittarius': 5, 'leo-aries': 5, 'leo-gemini': 4,
  'leo-libra': 3, 'leo-aquarius': 3, 'leo-taurus': 2,
  'leo-virgo': 2, 'leo-scorpio': 2, 'leo-pisces': 2,
  'leo-cancer': 2, 'leo-capricorn': 2,
  'virgo-capricorn': 5, 'virgo-taurus': 5, 'virgo-cancer': 4,
  'virgo-scorpio': 4, 'virgo-pisces': 3, 'virgo-gemini': 2,
  'virgo-libra': 2, 'virgo-aries': 2, 'virgo-leo': 2,
  'virgo-sagittarius': 2, 'virgo-aquarius': 2,
  'libra-aquarius': 5, 'libra-gemini': 5, 'libra-sagittarius': 4,
  'libra-leo': 3, 'libra-aries': 2, 'libra-taurus': 2,
  'libra-virgo': 2, 'libra-scorpio': 2, 'libra-pisces': 2,
  'libra-cancer': 2, 'libra-capricorn': 2,
  'scorpio-pisces': 5, 'scorpio-cancer': 5, 'scorpio-virgo': 4,
  'scorpio-capricorn': 4, 'scorpio-taurus': 3, 'scorpio-aries': 3,
  'scorpio-gemini': 2, 'scorpio-libra': 2, 'scorpio-leo': 2,
  'scorpio-sagittarius': 2, 'scorpio-aquarius': 2,
  'sagittarius-aries': 5, 'sagittarius-leo': 5, 'sagittarius-libra': 4,
  'sagittarius-gemini': 4, 'sagittarius-aquarius': 3, 'sagittarius-taurus': 2,
  'sagittarius-virgo': 2, 'sagittarius-scorpio': 2, 'sagittarius-pisces': 2,
  'sagittarius-cancer': 2, 'sagittarius-capricorn': 2,
  'capricorn-virgo': 5, 'capricorn-taurus': 5, 'capricorn-scorpio': 4,
  'capricorn-cancer': 3, 'capricorn-pisces': 3, 'capricorn-gemini': 2,
  'capricorn-libra': 2, 'capricorn-aries': 2, 'capricorn-leo': 2,
  'capricorn-sagittarius': 2, 'capricorn-aquarius': 2,
  'aquarius-libra': 5, 'aquarius-gemini': 5, 'aquarius-sagittarius': 4,
  'aquarius-aries': 3, 'aquarius-leo': 3, 'aquarius-taurus': 2,
  'aquarius-virgo': 2, 'aquarius-scorpio': 2, 'aquarius-pisces': 2,
  'aquarius-cancer': 2, 'aquarius-capricorn': 2,
  'pisces-scorpio': 5, 'pisces-cancer': 5, 'pisces-taurus': 4,
  'pisces-virgo': 3, 'pisces-capricorn': 3, 'pisces-gemini': 2,
  'pisces-libra': 2, 'pisces-aries': 2, 'pisces-leo': 2,
  'pisces-sagittarius': 2, 'pisces-aquarius': 2,
};

export function getCompatibility(sign1: ZodiacSign, sign2: ZodiacSign): number {
  if (sign1 === sign2) return 5;
  const key = `${sign1}-${sign2}`;
  return compatibilityMatrix[key] ?? compatibilityMatrix[`${sign2}-${sign1}`] ?? 3;
}
...
export function getZodiacCode(sign: ZodiacSign): number {
  return zodiacOrder.indexOf(sign);
}
...
export const zodiacData: Record<ZodiacSign, HoroscopeData> = {
  ...
  gemini: {
    ...
    personality: {
      ...
      description: '雙子座是風象星座中最活潑靈動的存在，擁有如水銀般靈活多變的思維。他們好奇心旺盛，對世界上一切事物都抱持著強烈的興趣，恨不得自己能夠同時體驗所有有趣的事情。雙子座是天生 的溝通高手，語言能力出眾，總能輕鬆與各種人建立聯繫，機智幽默的談吐讓身邊的人感到愉快。他們思維敏捷、反應快速，腦中永遠轉著無數的新點子，多才多藝的特質讓他們能在不同領域都有所涉獵。適應力極強是雙子座的優勢，無論環境如何變化都能從容應對。不過雙子座的多變也可能讓人難以捉摸，有時顯得有些不夠專一或缺乏恆心。他們熱愛資訊與知識的交流，腦中裝著五花八門的資訊，聊天時總能帶來新奇有趣的话题，是朋友圈中最受歡迎的開心果。'
    },
  ...
  capricorn: {
    ...
    personality: {
      traits: ['務實', '有毅力', '責任心強', '野心勃勃', '自律', '耐心', '傳統主義', '严肃', '有抱負', '策略思考'],
      description: '摩羯座是土象星座中最具企圖心的存在，他們如同登山者般，一步一腳印地向著山頂前進，從不放棄。他們務實踏實，不相信捷徑，只相信努力與紀律，自律甚嚴是達成目標的關鍵。責任感強的特質讓摩羯在職場與生活中都是最可靠的人選，交辦的事情一定會盡心盡力完成，是那種讓人安心的存在。野心勃勃的他們胸懷大志，不甘於平凡，渴望在社會上取得成就與地位，是天生的工作狂人。傳統而嚴肅的態度讓摩羯在處事上顯得較為謹慎，不會做出輕率的決定，每一步都是經過深思熟慮的。耐心是摩羯最大的武器之一，他們願意等待，為了長遠的目標可以忍受暫時的挫折與不順。策略思考讓他們在竟爭中總能發現突破口，穩健踏實地朝著目標前進。摩羯座不善於表達情感，但內心深處其實比誰都渴望被人理解與肯定，那份對成功的執著追求正是他们生命的最大動力。'
    },
